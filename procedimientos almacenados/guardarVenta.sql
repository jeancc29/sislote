...
-- , OUT psalida nvarchar(1000)
   ...
   select * from idventatemporals where idventatemporals.idVentaHash = idVentaHash COLLATE utf8mb4_unicode_ci and idventatemporals.idBanca = idBanca;
   if idVenta is null 
		then
...
select 'Final de las validaciones de las jugadas';
