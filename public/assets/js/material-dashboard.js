...
$(document).ready(function() {
    $sidebar = $(".sidebar"), window_width = $(window).width(), $("body").bootstrapMaterialDesign(), md.initSidebarsCheck(), window_width = $(window).width(), md.checkSidebarImage(), md.initMinimizeSidebar(), md.initFormExtendedDatetimepickers(), $(".dropdown-menu a.dropdown-toggle").on("click", function(e) {
        var a = $(this),
