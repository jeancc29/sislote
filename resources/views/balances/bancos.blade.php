  ...
  <div class="col-md-12">
      <div class="card " style="min-height: 1000px;">
        <div class="card-header card-header-info card-header-text">
          <div class="card-text">
            <h4 class="card-title">Balance por banco</h4>
          </div>
        </div>
        <div class="card-body ">
            ...
            <div class="row ">
                    ...
                    <div class="col-12 ">
                        ...
                        <div class="col-sm-4 mt-4">
                            ...
                            <label for="fechaBusqueda" class="bmd-label-floating font-weight-bold" style="color: black;">Tomar balance hasta la fecha</label>
                            <input ng-model="datos.fechaHasta" id="fechaBusquedaDesde" type="date" class="form-control" required>
                            </div>
                        </div>
                    ...
                    <div class="col-12">
                       ...
                       <div class="col-sm-3">
                            ...
                            <input autocomplete="off" ng-keyup="inputDescripcionBancaKeyUp()" ng-model="datos.nombreBancoFiltro" id="numeroTicketBusqueda" type="text" class="form-control">
                            </div>
                        </div>
                       </div>
                    ...
                    <table class="table table-sm table-striped" ng-init="mostrarVentanaTicket = false">
                        <thead>
                            <tr>
                            <th scope="col" class="text-center font-weight-bold" style="font-size: 14px;">#</th>
                            <th scope="col" class="text-center font-weight-bold" style="font-size: 14px;">Banco</th>
                            <!-- <th scope="col" class="text-center font-weight-bold" style="font-size: 14px;">Usuario</th> -->
                            <!-- <th scope="col" class="text-center font-weight-bold" style="font-size: 14px;">Cerrado</th> -->
                            <!-- <th scope="col" class="text-center font-weight-bold" style="font-size: 14px;">Dueno</th> -->
                            <th scope="col" class="text-center font-weight-bold" style="font-size: 14px;">Balance</th>
                            <!-- <th scope="col" class="text-center font-weight-bold" style="font-size: 14px;">Prestamo</th> -->
                        ...
                        <tbody>
                            <tr   ng-repeat="c in datos.bancas | filter:greaterThan(datos.accionBusqueda)">
                                <td ng-click="seleccionarTicket(c)" scope="col" class="text-center" style="font-size: 13px">@{{$index + 1}}</td>
                                <td ng-click="seleccionarTicket(c)" scope="col" class="text-center" style="font-size: 13px">@{{c.nombre}}</td>
                                ...
                                <td ng-class="{'bg-bien text-bien': (c.balance >= 0), 'bg-mal text-mal': (c.balance < 0)}" scope="col" class="text-center" style="font-size: 13px">@{{c.balance}}</td>
            ...
            <div class="card my-0 mx-0 d-inline-block mx-0" style="min-height: 350px; max-height: 350px; width: 100%; background: #dddddd; overflow-y: auto;"> <!-- min-height: 455px; max-height: 455px; -->
                ...
                <div class="table-responsive">
                  ...
                  <!-- <div class='loterias col-xs-12 text-center mx-3' style='border-top-style: dashed; border-bottom-style: dashed; font-weight: lighter'> -->
                    <h5 style=' padding: 8px; width: 75%; margin: auto; '  class='text-center font-weight-bold py-1 mt-2 mb-0'>@{{l.descripcionBancaFiltrocion}}</h5>
                  <!-- </div> -->
