  ...
  <div class="col-md-12">
      <div class="card ">
        <div class="card-header card-header-info card-header-text">
          <div class="card-text">
            <h4 class="card-title">Todos los grupos</h4>
          </div>
        </div>
...
<script src="{{asset('js/myflutterframework2.js' . '?' . '1.0.0' )}}" type="text/javascript"></script>
<script src="{{asset('js/grupo.js' . '?' . '1.0.0' )}}" type="text/javascript"></script>
